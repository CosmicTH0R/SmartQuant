...
// import { Moon, Sun, Search } from "lucide-react"; // Importing the search icon
...
//   return (
//     <nav className="from-sky-200 dark:from-gray-900 text-gray-900 dark:text-white px-6 py-3 flex items-center justify-between">
//       {/* Logo */}
...
//         <button
//           onClick={() => setIsSearchOpen(!isSearchOpen)} // Toggle search on click
