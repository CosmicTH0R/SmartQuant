...
const transactions = [
  ...
  },
  {
    ...
    date: "Apr 12, 2025",
    status: "Completed",
    description: "To Trading Account",
  },
  {
    id: 4,
    type: "Deposit",
      ...
      <div className="min-h-screen bg-gradient-to-b from-sky-200 to-white dark:from-gray-900 dark:to-black px-4 py-10 transition-colors">
        <div className="w-full max-w-6xl mx-auto px-2 sm:px-4 lg:px-6">
          <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2 md:mt-0 text-sm md:text-base">
            ...
            >
              <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4">
                  <h2 className="text-lg font-semibold text-gray-800 dark:text-white mb-2 sm:mb-0">
                    Recent Transactions
                  </h2>
                        ...
                        <div className="bg-gray-50 dark:bg-gray-750 rounded-lg p-3 space-y-2">
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <div>
                              ...
                              <div className="text-gray-800 dark:text-gray-200 font-mono break-all">
                                TXN-
                                {Math.random()
                                  .toString(36)
                                  .substring(2, 10)
            ...
            <form onSubmit={handleAddFunds}>
              ...
              <div className="flex flex-col sm:flex-row sm:justify-end gap-3">
                <button
                  type="button"
                  onClick={() => setShowAddFundsModal(false)}
                  className="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 order-2 sm:order-1"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 shadow-md order-1 sm:order-2"
                >
                  Add Funds
                </button>
              </div>
